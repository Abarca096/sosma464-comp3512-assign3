...
protected function getPrimaryKeyName(){
 ...
 {
 return "SELECT COUNT(b1.CountryCode) as count, c1.CountryName as countryName FROM BookVisits as b1, Countries as c1 WHERE c1.CountryCode = b1.CountryCode GROUP BY c1.CountryName ORDER BY COUNT(b1.CountryCode) DESC LIMIT 15";
 }
